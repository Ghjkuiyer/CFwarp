...
if [[ ${bit} == "x86_64" ]]; then
wget -N https://cdn.jsdelivr.net/gh/Ghjkuiyer/CFwarp/wgcf_2.2.9_amd64 -O /usr/local/bin/wgcf && chmod +x /usr/local/bin/wgcf         
elif [[ ${bit} == "aarch64" ]]; then
wget -N https://cdn.jsdelivr.net/gh/Ghjkuiyer/CFwarp/wgcf_2.2.9_arm64 -O /usr/local/bin/wgcf && chmod +x /usr/local/bin/wgcf
fi
if [[ ${vi} == "lxc" || ${vi} == "openvz" ]]; then
wget -N https://cdn.jsdelivr.net/gh/Ghjkuiyer/CFwarp/wireguard-go -O /usr/bin/wireguard-go && chmod +x /usr/bin/wireguard-go
fi
...
wget -N --no-check-certificate https://cdn.jsdelivr.net/gh/Ghjkuiyer/CFwarp/sip.sh >/dev/null 2>&1
...
wget -N --no-check-certificate https://cdn.jsdelivr.net/gh/Ghjkuiyer/warp-plus/wp.py
python3 wp.py
}

function upcore(){
wget -N --no-check-certificate https://cdn.jsdelivr.net/gh/Ghjkuiyer/CFwarp/ucore.sh && chmod +x ucore.sh && ./ucore.sh
}
...
function up4(){
wget -N --no-check-certificate https://raw.githubusercontent.com/Ghjkuiyer/CFwarp/main/CFwarp.sh && chmod +x CFwarp.sh && ./CFwarp.sh
}
